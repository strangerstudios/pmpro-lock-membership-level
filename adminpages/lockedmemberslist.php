...
?>
	...
	<?php
		...
		if($s)
		{
			...
			$sqlQuery .= " AND um.meta_key = 'pmprolml' AND um.meta_value = '1'";
	...
	<table class="widefat">
		...
		<tbody id="users" class="list:user user-list">
			<?php
				...
				?>
				<tr>
					<td colspan="9"><p><?php _e("No members found.", "pmpro");?> <?php if($l) { ?><a href=""><?php _e("Search all levels", "pmpro");?></a>.<?php } ?></p></td>
				</tr>
				<?php
				}
			?>
